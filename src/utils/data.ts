	...
	projects: [
		{
			...
			status: "ongoing",
			description:
				"A SAAS Startup designed to provide a resource collection for all professionals, showcases their portfolio, and the services they offer. This project was built using Next.js for full-stack development, Supabase Postgres and Drizzle ORM for database management, and TailwindCSS, Shadcn, and NextUI for styling",
			purpose:
				"This SAAS startup is built to simplify the professional journey by offering a centralized platform where individuals across industries can discover, save, and revisit valuable resources, including tools, tutorials, templates, and services. More than just a resource hub, it empowers professionals to showcase their expertise through personalized portfolios, making it easier to connect with clients, collaborators, or potential employers. Whether you're looking for the right tools to enhance your work or a way to present your skills to the world, this platform serves as a one-stop solution to help professionals stay organized, visible, and ready for new opportunities.",
			key_features:
				"This platform offers a rich collection of resources, portfolios, and services for professionals and recruiters to explore, connect, and share. It also includes a variety of powerful features, such as: <ul class='list-disc mt-5 ml-10'> <li>Resource filtering and bookmarks to quickly find and save essential tools, tutorials, and templates.</li> <li>Web scraping to automatically gather data for resources and portfolios, reducing manual entry.</li> <li>Easy sign-in with Google or GitHub for seamless access.</li> <li>Email verification for those who prefer traditional email sign-ups.</li> <li>Personalized portfolio pages with customizable themes and sections.</li> <li>Service listings where professionals can showcase the services they offer to potential clients.</li> <li>Community-driven ratings and reviews to highlight high-quality resources and portfolios.</li> <li>Collaboration tools that allow professionals to connect and work together on projects.</li> <li>More features are in development to enhance the user experience even further!</li> </ul>",
			roles_and_responsibilities:
				"As the sole developer of this SAAS startup, I oversee every aspect of the project, from design and development to deployment and optimization. My responsibilities include crafting an intuitive user interface, building a robust back-end, managing the database, and ensuring smooth performance. My focus is on delivering a seamless experience that enables professionals to discover, showcase, and share resources effortlessly. I continuously refine the platform, incorporating feedback and making improvements to enhance both usability and functionality, ensuring it evolves to meet user needs effectively.",
			technologies: [
				"html",
				"css",
				"javascript",
		...
		},
		{
			...
			technologies: ["html", "css", "javascript", "php", "mysql", "git", "github"],
			type: "UI/UX Design, Development",
