...
const Menu: React.FC<Props> = ({ useReference, historyReturn }) => {
	...
	return (
		...
		>
			<div className="left-menu transition-all duration-0 hidden bg-[black] w-[15rem] 2xl:w-[20rem] h-0 md:flex flex-col justify-between items-start">
			...
			<div className="right-menu w-full relative h-full">
				...
				<div className="flex flex-col px-24 md:px-32 2xl:px-48 justify-evenly h-full">
					...
					<div className="menu-nav flex flex-col items-center md:items-start gap-5">
